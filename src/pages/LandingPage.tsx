...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="pb-20 selection:bg-mars-500 selection:text-white">
      {/* 1. TOP TELEMETRY STATUS BAR (NO SCROLLBAR) */}
      <div className="border-b border-slate-800/80 bg-space-950/90 backdrop-blur-md sticky top-14 z-30 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div className="flex flex-wrap items-center justify-between gap-y-1 gap-x-3 text-[11px] font-mono text-slate-400">
            <div className="flex items-center gap-2 text-mars-400 font-bold shrink-0">
      ...
      <div className="space-y-16 sm:space-y-20 lg:space-y-24">
        {/* 2. HERO SECTION */}
        <section className="relative pt-3 sm:pt-5 lg:pt-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Content */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-mars-950/80 border border-mars-500/40 text-mars-300 text-xs font-mono shadow-[0_0_15px_rgba(255,77,46,0.2)]">
              <Sparkles className="w-3.5 h-3.5 text-mars-400" />
              <span>NASA SPACE APPS CHALLENGE 2026 · THE NEXT FRONTIER</span>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
              <Link to="/mission/location">
                <Button variant="mars" size="lg" icon={<Rocket className="w-5 h-5" />}>
                  Start Mission
                </Button>
              </Link>
              <Button
              ...
              <Link to="/science">
                <Button variant="ghost" size="lg" icon={<Database className="w-4 h-4" />}>
                  Explore Science
                </Button>
              </Link>
            </div>
            ...
            {/* Grounding Badges */}
            <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs font-mono text-slate-400 border-t border-slate-800/80">
              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded bg-space-900/80 border border-slate-800">
                <span className="w-2 h-2 rounded-full bg-bio-400" />
          ...
          {/* Right Interactive 3D Mars Scene */}
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="w-full max-w-[440px] flex flex-col items-center gap-3">
              <div className="w-full aspect-square rounded-2xl hud-panel p-2 relative shadow-[0_0_60px_rgba(255,77,46,0.18)]">
                <MarsGlobe interactive={true} className="h-full" showFullscreenButton={true} />
                <div className="absolute bottom-4 left-4 right-4 bg-space-950/80 backdrop-blur-sm border border-slate-800/80 rounded-lg p-2 text-center text-[10px] font-mono text-slate-400 pointer-events-none">
                  <span>🖱 Drag to rotate globe · Click landing zones to scout</span>
                </div>
              </div>
              <Link
                to="/solar-system"
                className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-space-900 via-mars-950/50 to-space-900 border border-mars-500/40 hover:border-mars-400 text-xs font-mono font-bold text-mars-300 hover:text-white flex items-center justify-center gap-2 transition-all shadow-sm hover:shadow-[0_0_20px_rgba(255,77,46,0.3)] group"
              >
                <Maximize2 className="w-3.5 h-3.5 text-mars-400 group-hover:scale-110 transition-transform" />
                <span>VIEW FULL SCREEN // EXPLORE SOLAR SYSTEM</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="hud-panel rounded-2xl p-8 sm:p-10 border-cyan-500/20 relative overflow-hidden space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-red-950/20 border border-red-500/30 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-red-400 uppercase font-bold tracking-wider">Option A · Earth Resupply Lifeline</span>
                <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-red-950 text-red-300 border border-red-500/40">Critical Risk</span>
              </div>
            ...
            <div className="p-6 rounded-xl bg-bio-950/20 border border-bio-500/30 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-bio-400 uppercase font-bold tracking-wider">Option B · In-Situ Martian Bio-Dome</span>
                <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-bio-950 text-bio-300 border border-bio-500/40">Humanity's Future</span>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-300 font-mono">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-bio-400 shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-4 border-t border-slate-800">
            <div className="bg-space-950/80 border border-slate-800/80 rounded-xl p-4">
              <p className="text-xs font-mono text-slate-400">Interplanetary Distance</p>
              <p className="text-2xl sm:text-3xl font-bold font-display text-cyan-300 mt-1">225M km</p>
              <p className="text-[11px] font-mono text-slate-400 mt-1">9 months transit time</p>
            </div>
            <div className="bg-space-950/80 border border-slate-800/80 rounded-xl p-4">
              <p className="text-xs font-mono text-slate-400">Surface Temperature</p>
              <p className="text-2xl sm:text-3xl font-bold font-display text-cyan-300 mt-1">-63°C</p>
              <p className="text-[11px] font-mono text-slate-400 mt-1">Extreme diurnal swings</p>
            </div>
            <div className="bg-space-950/80 border border-slate-800/80 rounded-xl p-4">
              <p className="text-xs font-mono text-slate-400">Atmospheric Density</p>
              <p className="text-2xl sm:text-3xl font-bold font-display text-cyan-300 mt-1">&lt; 1%</p>
              <p className="text-[11px] font-mono text-slate-400 mt-1">0.636 kPa dry CO₂</p>
            </div>
            <div className="bg-space-950/80 border border-slate-800/80 rounded-xl p-4">
              <p className="text-xs font-mono text-slate-400">Solar Irradiance</p>
              <p className="text-2xl sm:text-3xl font-bold font-display text-cyan-300 mt-1">43%</p>
              <p className="text-[11px] font-mono text-slate-400 mt-1">Relative to Earth sun</p>
            </div>
          </div>
        </div>
      </section>

      {/* 4. INTERACTIVE MARS ENVIRONMENTAL CONDITIONS MATRIX (MD SPECIFICATION) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="space-y-2">
          <p className="text-xs font-mono text-cyan-400 uppercase tracking-widest">Martian Planetary Hazards & NASA Data</p>
          <h2 className="text-3xl font-bold font-display text-white">Interactive Environmental Conditions Matrix</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg ${isActive ? 'bg-cyan-950/80 border border-cyan-500/40' : 'bg-space-900'}`}>
                      {condition.icon}
                    </div>
                    <div>
                      <p className="text-xs font-bold font-display leading-tight">{condition.name}</p>
                      <p className="text-[10px] font-mono text-slate-400 mt-0.5">{condition.metric}</p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-7">
            <div className="hud-panel rounded-2xl p-6 sm:p-8 border-cyan-500/30 h-full flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold font-display text-white">{currentCondition.name}</h3>
                      <p className="text-xs font-mono text-cyan-300">{currentCondition.metric}</p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-xs font-mono text-slate-200 bg-space-950 p-2.5 rounded-lg border border-slate-800/80">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed bg-red-950/20 p-3 rounded-lg border border-red-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed bg-bio-950/20 p-3 rounded-lg border border-bio-500/20">
              ...
              <div className="pt-4 border-t border-slate-800 flex justify-between items-center text-xs font-mono">
                ...
                <Link to="/science" className="text-cyan-400 hover:underline flex items-center gap-1">
                  <span>View All NASA Sources</span>
      ...
      {/* 5. VIRTUAL MARS GREENHOUSE ARCHITECTURE (WOW FEATURE FROM marsfarm.md) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <p className="text-xs font-mono text-bio-400 uppercase tracking-widest">Closed-Loop Life Support Engineering</p>
          <h2 className="text-3xl font-bold font-display text-white">The Martian Bio-Dome Architecture</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Subsystem 1 */}
          <div className="hud-panel rounded-2xl p-6 border-cyan-500/20 space-y-3 hover:border-cyan-400/50 transition-all">
            <div className="w-10 h-10 rounded-xl bg-yellow-950/80 border border-yellow-500/40 flex items-center justify-center text-yellow-400">
              <Zap className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold font-display text-slate-100">Photovoltaic & Storage Grid</h3>
          ...
          <div className="hud-panel rounded-2xl p-6 border-cyan-500/20 space-y-3 hover:border-cyan-400/50 transition-all">
            ...
            <h3 className="text-base font-bold font-display text-slate-100">Closed-Loop ECLSS Water Loop</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          {/* Subsystem 3 */}
          <div className="hud-panel rounded-2xl p-6 border-cyan-500/20 space-y-3 hover:border-cyan-400/50 transition-all">
            <div className="w-10 h-10 rounded-xl bg-bio-950/80 border border-bio-500/40 flex items-center justify-center text-bio-400">
              <Leaf className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold font-display text-slate-100">LED Aeroponics & Hydroponics</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          {/* Subsystem 4 */}
          <div className="hud-panel rounded-2xl p-6 border-cyan-500/20 space-y-3 hover:border-cyan-400/50 transition-all">
            <div className="w-10 h-10 rounded-xl bg-mars-950/80 border border-mars-500/40 flex items-center justify-center text-mars-400">
              <Wind className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold font-display text-slate-100">Biosphere Climate Regulation</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="hud-panel-mars rounded-3xl p-8 sm:p-10 border-orange-500/30 space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-800 pb-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-mars-950 border border-mars-500/40 text-mars-400 text-xs font-mono mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              {/* Crew Slider */}
              <div className="space-y-2 bg-space-950/70 p-4 rounded-xl border border-slate-800">
                <div className="flex justify-between text-xs font-mono">
                  <span className="text-slate-300 font-bold">ASTRONAUT CREW SIZE</span>
                  <span className="text-cyan-400 font-bold text-sm">{sandboxCrew} Crew Members</span>
                </div>
                <input
                  type="range"
                  min={1}
              ...
              <div className="space-y-2 bg-space-950/70 p-4 rounded-xl border border-slate-800">
                <div className="flex justify-between text-xs font-mono">
                  ...
                  <span className="text-bio-400 font-bold text-sm">{sandboxFarmArea} m²</span>
                </div>
                <input
                  type="range"
                  min={25}
                ...
                <div className="flex justify-between text-[10px] font-mono text-slate-500">
                  ...
                  <span>300 m² (Industrial)</span>
                </div>
              </div>
            </div>

            {/* Live Sandbox Telemetry Card */}
            <div className="lg:col-span-6 bg-space-950/90 border border-cyan-500/30 rounded-2xl p-6 space-y-5 shadow-xl">
              <div className="flex justify-between items-center border-b border-slate-800 pb-3">
                <span className="text-xs font-mono text-slate-400 uppercase">Calculated Mission Sustainability</span>
                <span className={`px-2.5 py-1 rounded-full text-xs font-mono font-bold uppercase border ${
                  ...
                  {coveragePercent >= 100 ? '🟢 100% Calorie Autonomy' : coveragePercent >= 70 ? '🟡 Partial Deficit / Rationing' : '🔴 Severe Starvation Risk'}
                </span>
              </div>

              <div className="grid grid-cols-2 gap-4 text-xs font-mono">
                <div className="p-3 rounded-lg bg-space-900/90 border border-slate-800">
                  <span className="text-[10px] text-slate-400 block">Daily Caloric Demand</span>
                  <span className="text-lg font-bold text-slate-200">{dailyCalorieDemand.toLocaleString()} kcal/day</span>
                  <span className="text-[10px] text-slate-500 block mt-0.5">2,500 kcal per astronaut</span>
                </div>

                <div className="p-3 rounded-lg bg-space-900/90 border border-slate-800">
                  <span className="text-[10px] text-bio-400 block">Est. Daily Harvest Output</span>
                  <span className="text-lg font-bold text-bio-300">+{dailyCalorieProduced.toLocaleString()} kcal/day</span>
                  <span className="text-[10px] text-slate-500 block mt-0.5">~135 kcal / m² yield mix</span>
                </div>

                <div className="p-3 rounded-lg bg-space-900/90 border border-slate-800">
                  <span className="text-[10px] text-cyan-400 block">Daily Water Recirculation</span>
                  <span className="text-lg font-bold text-cyan-300">{dailyWaterLoopL.toLocaleString()} L / sol</span>
                  <span className="text-[10px] text-slate-500 block mt-0.5">98% recycled via condensers</span>
                </div>

                <div className="p-3 rounded-lg bg-space-900/90 border border-slate-800">
                  <span className="text-[10px] text-amber-400 block">Oxygen Coproduction</span>
                  <span className="text-lg font-bold text-amber-300">+{dailyOxygenProducedKg} kg O₂ / sol</span>
                  <span className="text-[10px] text-slate-500 block mt-0.5">Photosynthetic respiration</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full h-3 bg-space-900 rounded-full overflow-hidden border border-slate-800">
                  <div
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          <div>
            <p className="text-xs font-mono text-cyan-400 uppercase tracking-widest">Bio-Regenerative Life Support</p>
            <h2 className="text-3xl font-bold font-display text-white">Martian Crop Cultivars</h2>
          ...
          {CROPS_DATA.map((crop) => {
            ...
            return (
              <div
                ...
                className={`hud-panel rounded-xl p-4 text-center space-y-2 cursor-pointer transition-all group ${
                  isSelected
                    ? 'border-bio-400 bg-space-900 shadow-[0_0_20px_rgba(16,185,129,0.25)]'
                    : 'hover:border-bio-400/50 hover:bg-space-900/50'
                }`}
              >
                <span className="text-4xl inline-block group-hover:scale-110 transition-transform">{crop.emoji}</span>
                <p className="font-display font-bold text-sm text-slate-200">{crop.name}</p>
                <p className="text-[11px] font-mono text-bio-400 font-bold">{crop.caloriesPerKg} kcal/kg</p>
        ...
        <div className="p-6 rounded-2xl bg-space-900/60 border border-bio-500/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <span className="text-5xl p-3 rounded-2xl bg-space-950 border border-slate-800">{activeCrop.emoji}</span>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold font-display text-white">{activeCrop.name}</h3>
                <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-bio-950 text-bio-300 border border-bio-500/40">
                  NASA Cultivar
                </span>
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-center font-mono text-xs w-full md:w-auto shrink-0">
            <div className="bg-space-950 p-2.5 rounded-lg border border-slate-800">
              <span className="text-[10px] text-slate-400 block">Water Demand</span>
              <span className="font-bold text-cyan-300">{activeCrop.waterPerKgLiters} L/kg</span>
            </div>
            <div className="bg-space-950 p-2.5 rounded-lg border border-slate-800">
              <span className="text-[10px] text-slate-400 block">Energy Demand</span>
              <span className="font-bold text-amber-300">{activeCrop.energyPerKgKwh} kWh/kg</span>
            </div>
            <div className="bg-space-950 p-2.5 rounded-lg border border-slate-800">
              <span className="text-[10px] text-slate-400 block">Protein Content</span>
              <span className="font-bold text-bio-300">{activeCrop.proteinGramsPerKg} g/kg</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="text-center space-y-2">
          <p className="text-xs font-mono text-bio-400 uppercase tracking-widest">End-to-End Mission Lifecycle</p>
          <h2 className="text-3xl font-bold font-display text-white">How the MARS FARM Simulation Operates</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {workflowSteps.map((step) => (
            <Card key={step.num} variant="default" className="relative group hover:border-cyan-400/50">
              <div className="flex justify-between items-start mb-4">
                <span className="text-2xl font-bold font-mono text-slate-500 group-hover:text-cyan-400 transition-colors">
                  {step.num}
                </span>
              ...
              <h3 className="text-base font-bold font-display text-slate-100 mb-2">{step.title}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="hud-panel-mars rounded-3xl p-10 sm:p-14 text-center space-y-6 relative overflow-hidden shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-mars-950 border border-mars-500/40 text-mars-400 text-xs font-mono">
          ...
          <div className="pt-2 flex flex-wrap justify-center gap-4">
            ...
            <Button variant="secondary" size="lg" onClick={handleStartDemo} icon={<Play className="w-4 h-4 text-cyan-400" />}>
              Run 3-Minute Demo
            </Button>
            <Link to="/leaderboard">
              <Button variant="outline" size="lg" icon={<Activity className="w-4 h-4 text-bio-400" />}>
                View Leaderboard
              </Button>
            </Link>
          </div>
