...
export const MARS_SURFACE_DATA: Record<string, MarsSurfaceDetail> = {
  ...
  'kennedy-space-center': {
    ...
    celestialBody: 'earth',
    bodyType: 'earth',
    satelliteTextureUrl: 'https://images-assets.nasa.gov/image/PIA12235/PIA12235~large.jpg',
    googleEarthUrl: 'https://earth.google.com/web/@28.5721,-80.6480,12a,1500d,35y,0h,45t,0r',
    googleMapsEmbedUrl: 'https://maps.google.com/maps?q=28.5721,-80.6480&t=k&z=15&ie=UTF8&iwloc=&output=embed',
    ...
    images: [
      {
        ...
        title: 'NASA / Google Earth 3D Aerial: Pad 39A Launch Mount & Flame Trench',
        mission: 'NASA Exploration Ground Systems / USGS Orthophoto',
        instrument: 'High-Altitude Aerial Reconnaissance & Photogrammetry',
        solOrDate: 'Artemis & Commercial Crew Era',
        credit: 'NASA / USGS / Kim Shiflett',
        description:
          'High-altitude 3D aerial perspective of historic Launch Complex 39A, the crawlerway, flame trench, and the Atlantic coastline at Cape Canaveral.',
        imageUrl: 'https://images-assets.nasa.gov/image/KSC-20201115-PH-KLS01_0001/KSC-20201115-PH-KLS01_0001~large.jpg',
      ...
      },
      {
        ...
        title: 'ISS Handheld 3D Perspective: Cape Canaveral & Barrier Islands',
        mission: 'International Space Station / Crew Earth Observations',
        instrument: 'Nikon D5 Digital SLR (400mm lens)',
        solOrDate: 'Expedition 64 Flight Pass',
        credit: 'NASA / Johnson Space Center',
        description:
          'Astronaut photograph from 400 km orbital altitude capturing the entire Merritt Island barrier reef, Kennedy Space Center launch complexes, and the Indian River Lagoon.',
        imageUrl: 'https://images-assets.nasa.gov/image/iss064e007861/iss064e007861~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/iss064e007861/iss064e007861~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
      {
        id: 'ksc-landsat-ortho',
        title: 'NASA Landsat 9 / Earth Observatory: Space Coast Multispectral Satellite Map',
        mission: 'NASA Earth Observatory / Landsat 9',
        instrument: 'Operational Land Imager-2 (OLI-2)',
        solOrDate: 'True-Color Surface Radiance',
        credit: 'NASA / USGS Earth Resources Observation and Science (EROS)',
        description:
          'Orthorectified true-color satellite capture showing the launch pads, runway landing facility, and coastal waters of Florida’s Space Coast from sun-synchronous orbit.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA12235/PIA12235~large.jpg',
      ...
      },
      {
        ...
        title: 'NASA Advanced Plant Habitat (APH) Microgravity Chamber',
        ...
        imageUrl: 'https://images-assets.nasa.gov/image/iss056e201247/iss056e201247~large.jpg',
  ...
  'mauna-kea': {
    ...
    celestialBody: 'earth',
    bodyType: 'earth',
    satelliteTextureUrl: 'https://images-assets.nasa.gov/image/PIA02652/PIA02652~large.jpg',
    googleEarthUrl: 'https://earth.google.com/web/@19.8206,-155.4681,4205a,4000d,35y,0h,60t,0r',
    googleMapsEmbedUrl: 'https://maps.google.com/maps?q=19.8206,-155.4681&t=k&z=14&ie=UTF8&iwloc=&output=embed',
    ...
    images: [
      {
        id: 'mauna-kea-aster-3d',
        title: 'NASA Terra ASTER: 3D Digital Elevation Model & Volcanic Ridge',
        mission: 'NASA Earth Observatory / ASTER',
        instrument: '3D Stereo Digital Elevation Radiometer',
        solOrDate: 'High-Altitude Earth Survey',
        credit: 'NASA / JPL / METI / ERSDAC / JAROS',
        description:
          'High-resolution 3D perspective elevation model derived from stereo infrared satellite imagery, showing the rugged cinder cones of Mauna Kea mimicking Martian volcanic terrain.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA02652/PIA02652~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/PIA02652/PIA02652~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
      {
        id: 'mauna-kea-iss-oblique',
        title: 'ISS Astronaut Oblique 3D Capture: Hawaiian Volcanoes Above Clouds',
        mission: 'NASA Earth Observatory / ISS Expedition 42',
        instrument: 'Nikon D4 Digital Camera (800mm telephoto)',
        solOrDate: 'Orbital Sunset Pass',
        credit: 'NASA / Crew Earth Observations',
        description:
          'Stunning oblique 3D photograph taken from the International Space Station showing the summit of Mauna Kea and its world-class observatories rising above the maritime cloud inversion layer.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA01821/PIA01821~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/PIA01821/PIA01821~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
      {
        id: 'hi-seas-dome-habitat',
        title: 'NASA HI-SEAS Geodesic Habitat on Volcanic Basalt Plain',
        mission: 'NASA Human Research Program (HRP)',
        instrument: 'Mission Field Documentation & Sensor Array',
        solOrDate: 'Mission VI Mars Simulation',
        credit: 'NASA / University of Hawaii / HI-SEAS',
        description:
          'The HI-SEAS analog biodome on the rugged volcanic slopes of Mauna Loa, simulating Mars long-duration habitation and crop sustainability.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA17596/PIA17596~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/PIA17596/PIA17596~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
      {
        id: 'mauna-kea-landsat-mosaic',
        title: 'NASA Landsat: Hawaii Volcanic Caldera & Summit Plateau Satellite Map',
        mission: 'NASA Earth Resources / Landsat Satellite',
        instrument: 'Thematic Mapper (TM)',
        solOrDate: 'Multispectral Baseline Survey',
        credit: 'NASA / USGS',
        description:
          'Satellite view of the volcanic tephra fields, barren basalt lava flows, and observatory plateau on Mauna Kea.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA03444/PIA03444~large.jpg',
  ...
  'svalbard-vault': {
    ...
    celestialBody: 'earth',
    bodyType: 'earth',
    satelliteTextureUrl: 'https://images-assets.nasa.gov/image/PIA01824/PIA01824~large.jpg',
    googleEarthUrl: 'https://earth.google.com/web/@78.2358,15.4913,130a,1600d,35y,0h,55t,0r',
    googleMapsEmbedUrl: 'https://maps.google.com/maps?q=78.2358,15.4913&t=k&z=15&ie=UTF8&iwloc=&output=embed',
    ...
    images: [
      {
        id: 'svalbard-modis-mosaic',
        title: 'NASA Terra MODIS: Arctic Svalbard Glaciers & Spitsbergen 3D Mosaic',
        mission: 'NASA Earth Observatory / Terra MODIS',
        instrument: 'Moderate Resolution Imaging Spectroradiometer (MODIS)',
        solOrDate: 'Arctic Polar Orbit Pass',
        credit: 'NASA / Goddard Space Flight Center',
        description:
          'Spectacular true-color satellite capture of Spitsbergen Island and the frozen fjords surrounding the Svalbard Global Seed Vault.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA01824/PIA01824~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/PIA01824/PIA01824~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
      {
        id: 'svalbard-vault-portal',
        title: 'Svalbard Global Seed Vault: Concrete Entrance Portal in Arctic Permafrost',
        mission: 'NordGen / Global Crop Diversity Trust / NASA Cryosphere',
        instrument: 'High-Resolution Field Survey',
        solOrDate: 'Arctic Winter Solstice',
        credit: 'NordGen / Norwegian Ministry of Agriculture',
        description:
          'The iconic concrete entrance portal of the Svalbard Global Seed Vault protruding from the snow-covered sandstone slopes of Platåberget.',
      ...
      {
        id: 'svalbard-glaciers-landsat',
        title: 'NASA Landsat 8: Longyearbyen Fjord & Platåberget Permafrost Satellite Map',
        mission: 'NASA / USGS Landsat 8',
        instrument: 'Operational Land Imager (OLI)',
        solOrDate: 'Polar Summer Cryo-Observation',
        credit: 'NASA Earth Observatory / USGS',
        description:
          'High-resolution satellite view of the Adventfjorden valley, Longyearbyen airport, and Platåberget plateau housing the world’s agricultural seed vault.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA14422/PIA14422~large.jpg',
      ...
      },
      {
        ...
        title: 'Deep Bedrock Cryogenic Seed Storage Vault (-18°C Safeguarding 1.2M Samples)',
        mission: 'Global Crop Diversity Trust',
        instrument: 'Repository Crypt Environmental Telemetry',
        solOrDate: 'Seed Preservation Archive',
        credit: 'Global Crop Diversity Trust / NordGen',
        description:
          'Subterranean vault chamber holding 1.2 million crop samples sealed in moisture-proof foil packages at -18°C inside Arctic permafrost bedrock.',
        imageUrl: 'https://images-assets.nasa.gov/image/PIA02652/PIA02652~large.jpg',
        thumbnailUrl: 'https://images-assets.nasa.gov/image/PIA02652/PIA02652~thumb.jpg',
        fallbackUrl: '/textures/earth_realistic.jpg',
      },
